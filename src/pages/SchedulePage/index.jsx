    ...
    <div className="scheduleContainer">
      <div className="scheduleFormContainer">
        ...
        <label className="scheduleInputWrapper" htmlFor="date">
          <i><HiOutlineCalendarDays size={24} color='#26262699'/></i>
          <input
        ...
        <label className="scheduleInputWrapper" htmlFor="hora">
          <i><CiStopwatch size={24} color='#26262699'/></i>
          <select
          name="hora" 
          id="hora">
        ...
        <label className="scheduleInputWrapper" htmlFor="service">
          <i><CiRollingSuitcase size={24} color='#26262699'/></i>
          <select
          name="service" 
          id="service">
        ...
        <div className="scheduleActionsContainer">
          <a href="/scheduleConfirm"><button>Agendar</button></a>
          <a href="/home"><button id='last'>Cancelar</button></a>
        </div>
        </div>
      </div>
    </div>
